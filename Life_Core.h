...
namespace life {
    ...
    public:
        ...
        void friend getNameUniverce(std::ifstream &, std::string &, Life &);

        void friend getRulesUniverse(std::ifstream &, std::string &, Life &);

        void friend getWeightAndHeight(std::ifstream &, std::string &, Life &);

        void friend getAliveCell(std::ifstream &, std::string &, Life &);
